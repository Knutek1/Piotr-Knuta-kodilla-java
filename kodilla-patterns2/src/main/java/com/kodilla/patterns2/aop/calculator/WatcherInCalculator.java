...
@Aspect
@Component
public class WatcherInCalculator {
    private static final Logger LOGGER = LoggerFactory.getLogger(WatcherInCalculator.class);
    ...
    public Object measureTime(final ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        Object result;
        try {long begin = System.currentTimeMillis();                  // [1]
