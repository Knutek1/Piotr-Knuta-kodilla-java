...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://knutek1.github.io/";
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                ...
                .forEach(theForm -> {                                          // [7]
                    ...
                    WebElement buttonDeleteCard =                              // [11]
                            theForm.findElement(By.xpath(".//button[4]")); // [12]
                    buttonDeleteCard.click();  // [13]
                });                                                            // [14]
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("-----");
        driverTrello.findElement(By.xpath("*[@id=\"login-submit\"]/span")).click();// [3]
    ...
    private void cleanUpTask(String taskName) throws InterruptedException{
        driver.navigate().refresh();                                         // [1]
